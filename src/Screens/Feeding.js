        ...
        <>
            ...
            <View style={{
                ...
                <View style={{ alignItems: "flex-start", marginHorizontal: 10 }}>
                    <Text style={[styles.Title, { color: "#fff", marginTop: 20, fontSize: 20, fontWeight: "bold" }]}>UBUTUMWA BW'INGENZI KUMIRIRE Y'ABANA</Text>
                </View>
                ...
                <View style={styles.container}>
                    <View style={{ marginTop: 2 }}>
                        ...
                        <View style={{ marginTop: 2, marginHorizontal: 15 }}>
                            <Text style={styles.Title}>Mubyeyi</Text>
                            <Text style={styles.Texties}>Onsa umwana wawe gusa (habe no kumuha amazi) kuva akivuka kugeza ku mezi 6 bbizamurinda kurwaragurika kandi bitume akura neza.</Text>

                            <Text style={styles.Title}>Nyuma y'amezi 6:</Text>
                            <Text style={styles.Texties}>Komeza umwonse unamuha ifashabere igizwe n'indyo yuzuye Kueza byibuze ku myaka ibiri</Text>

                            <Text style={styles.Title}>Bagabo</Text>
                            <Text style={styles.Texties}>Mwite ku mirire y'abana bityo bizatuma bakura neza</Text>
